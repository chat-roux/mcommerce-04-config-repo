...
##############################################################################
git remote add distantHttps https://github.com/chat-roux/mcommerce-04-config-repo.git
git remote add distantSsh git@github.com:chat-roux/mcommerce-04-config-repo.git
